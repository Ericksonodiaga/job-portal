"""
Django settings for softkenya project.
...
"""
fix url errors by changing details to
...
"""
Required Fields in Linked Developers site (App)
     - redirect url - http://localhost:8000/social-auth/complete/linkedin-oauth2/
     - Select Products > Sign in with linked in
"""
...
"""
Redirect url must be registered with google

      I set the Authorized redirect URL's in OAuth 2.0 Client IDs on https://console.cloud.google.com/apis/credentials?project=coastal-sector-236311 to
      http://localhost:8000/social-auth/complete/google-oauth2/

      changed credentials to my personal credentials
"""
