...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cv'].label = "Upload Cv"
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'email', 'phone_number', 'cv', 'password1', 'password2', 'gender']
...
class EmployeeProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ["first_name", "last_name", "phone_number", 'cv', "gender"]
