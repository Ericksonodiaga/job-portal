...
from jobosoft.forms import *
from jobosoft.models import *
from jobosoft.permission import *
...
def home_view(request):
    ...
    print('ok')
    return render(request, 'jobosoft/index.html', context)
...
def job_list_View(request):
    ...
    return render(request, 'jobosoft/job-list.html', context)
...
def create_job_View(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse("jobosoft:single-job", kwargs={
                'id': instance.id
            }))
    ...
    return render(request, 'jobosoft/post-job.html', context)
...
def single_job_view(request, id):
    ...
    return render(request, 'jobosoft/job-single.html', context)
...
def search_result_view(request):
    ...
    return render(request, 'jobosoft/result.html', context)
...
def apply_job_view(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'jobosoft/Apply-job.html',{
            'form': form,
            "id": id,
        })
        ...
        if not applicant:
            ...
            # get files from POST stream and add the to the form
            ...
            if form.is_valid():
                ...
                return redirect(reverse("jobosoft:apply-job", kwargs={
                    'id': id
                }))
...
def dashboard_view(request):
    ...
    return render(request, 'jobosoft/dashboard.html', context)
...
def delete_job_view(request, id):
    ...
    return redirect('jobosoft:dashboard')
...
def all_applicants_view(request, id):
    ...
    return render(request, 'jobosoft/all-applicants.html', context)
...
def applicant_details_view(request, id):
    ...
    return render(request, 'jobosoft/applicant-details.html', context)
...
def job_edit_view(request, id=id):
    ...
    return render(request, 'jobosoft/job-edit.html', context)
